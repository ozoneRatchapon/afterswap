...
export const wasmengine_snapshot: (a: number, b: number) => [number, number];
export const rail_merkle_proof: (a: number, b: number, c: number) => [number, number];
export const rail_merkle_root: (a: number, b: number) => [number, number];
export const rail_record_hash: (a: number, b: number) => [number, number];
export const rail_verify_record: (a: number, b: number, c: number, d: number) => [number, number];
