...
| chop | 1.00109 | 0.99998 | 1.00139 | 1.00166 | -2.9 bps | -5.7 bps | +11.1 bps |
...
**G2a vs TWAP: +58.95 bps mean — PASS** · **G2b vs random-arm: +5.82 bps mean — PASS** · vs hold is report-only (regime-dependent opportunity cost).
...
Mean on_tick **1.054µs**, worst tick (bootstrap tournament incl. 1,054-FSM enumeration) **175.292µs**. Budgets: 1 ms / 1 s — PASS.
